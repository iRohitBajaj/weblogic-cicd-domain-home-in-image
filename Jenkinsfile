pipeline {
    ...
    environment {
        ...
        REQ_INSTALLERS_DIR = "${env.INSTALLERS_DIR_MASTER}"
        ...
        stage ('Build New Image') {
            ...
            steps {
                sh '''
                    ...
                    imagetool/bin/imagetool.sh create --tag ${IMAGE_NAME} --version 12.2.1.4.0 --jdkVersion=8u212 --wdtModel=BlogDomain-WDT.yaml --wdtArchive=BlogDomain-WDT.zip --wdtDomainHome=/u01/oracle/user_projects/domains/sample-domain2 --wdtVariables=BlogDomain-WDT.properties --wdtDomainType WLS --chown oracle:root
                '''
            }
        }
